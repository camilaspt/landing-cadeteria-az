          ...
          <div className="bg-[#111111] border border-[#9AFF4F]/20 rounded-3xl p-8 md:p-12">
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-lg">contacto@azcadeteria.com</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col justify-center items-center text-center">
                ...
                <h4 className="text-2xl font-bold mb-3">¿Necesitas un envío?</h4>
                <p className="text-gray-400 mb-6">Escribinos por WhatsApp y coordinamos tu entrega al instante</p>
                <a
                  href="https://wa.me/543400657887"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#25D366] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#20bd5a] transition-colors flex items-center gap-3"
                >
